...
os.environ['DJANGO_SETTINGS_MODULE'] = 'session_auth.settings'  

import django
django.setup()

project = 'Generare Adeverinte'
copyright = '2024, Ioana Gradinariu, Hatnean Cosmin'
author = 'Ioana Gradinariu, Hatnean Cosmin'
release = '2024'
